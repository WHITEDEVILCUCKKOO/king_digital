<style>
    ...
    /* icon circle -- now holds a real inline <svg>, no CSS background-image hacks */
    ...
    .home-ads_content--visual-features-item span svg {
        width: 22px;
        height: 22px;
        stroke: currentColor;
        fill: none;
    ...
    /* hover state -- icon circle inverts to navy, icon turns white, item lifts + tilts */
    .home-ads_content--visual-features-item:hover span {
        background-color: #1a2233;
        color: #ffffff;
        box-shadow: 0 16px 30px rgba(26, 34, 51, 0.28);
    }

    .home-ads_content--visual-features-item:nth-child(1) {
        top: 6px;
        left: 0;
    }

    .home-ads_content--visual-features-item:nth-child(1):hover span {
        transform: translateY(-4px) scale(1.08) rotate(-8deg);
    }

    .home-ads_content--visual-features-item:nth-child(1) h4::before {
        content: "Targeted Audience";
    }

    .home-ads_content--visual-features-item:nth-child(2) {
        top: 6px;
        right: 0;
    }

    .home-ads_content--visual-features-item:nth-child(2):hover span {
        transform: translateY(-4px) scale(1.08) rotate(8deg);
    }

    .home-ads_content--visual-features-item:nth-child(2) h4::before {
        content: "High Conversions";
    }

    .home-ads_content--visual-features-item:nth-child(3) {
        bottom: 6px;
        left: 0;
    }

    .home-ads_content--visual-features-item:nth-child(3):hover span {
        transform: translateY(-4px) scale(1.08) rotate(8deg);
    }

    .home-ads_content--visual-features-item:nth-child(3) h4::before {
        content: "Quality Leads";
    }

    .home-ads_content--visual-features-item:nth-child(4) {
        bottom: 6px;
        right: 0;
    }

    .home-ads_content--visual-features-item:nth-child(4):hover span {
        transform: translateY(-4px) scale(1.08) rotate(-8deg);
    }

    .home-ads_content--visual-features-item:nth-child(4) h4::before {
    ...
    /* rounded accent bar floating at the left edge, instead of a hard CSS border-left */
    .home-ads_content--info-features-item::before {
        content: "";
        position: absolute;
        left: 8px;
        top: 50%;
    ...
    /* hover state -- orange ring + lift, number badge inverts to navy/white */
    .home-ads_content--info-features-item:hover {
        border-color: #f47c28;
        box-shadow: 0 14px 30px rgba(244, 124, 40, 0.18);
        transform: translateY(-3px) rotate(-1deg);
    }

    .home-ads_content--info-features-item:hover span {
        background-color: #1a2233;
        color: #ffffff;
    }

    .home-ads_content--info-features-item:nth-child(1) span::before {
        content: "01";
    }

    .home-ads_content--info-features-item:nth-child(1) h4::before {
        content: "Google Search Ads";
    }

    .home-ads_content--info-features-item:nth-child(2) span::before {
        content: "02";
    }

    .home-ads_content--info-features-item:nth-child(2) h4::before {
        content: "Meta Lead Campaigns";
    }

    .home-ads_content--info-features-item:nth-child(3) span::before {
        content: "03";
    }

    .home-ads_content--info-features-item:nth-child(3) h4::before {
        content: "Conversion Tracking";
    }

    .home-ads_content--info-features-item:nth-child(4) span::before {
        content: "04";
    }

    .home-ads_content--info-features-item:nth-child(4) h4::before {
    ...
    .home-ads_content--info-cta:hover {
        transform: translateY(-3px);
        box-shadow: 0 16px 32px rgba(244, 124, 40, 0.45);
    }
    ...
    @media (max-width:900px) {
        ...
        /* stack info on top, visual below on mobile */
        .home-ads_content--info {
            order: 1;
        }
